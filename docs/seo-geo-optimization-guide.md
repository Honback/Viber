...
**적용:**
- 홈페이지: 첫 섹션에 "Viber는 바이브 코딩으로 만든 프로젝트를 공유하는 쇼케이스 플랫폼입니다" 명확한 정의
