...
function buildFaqItems(data: SerializedHomepageData): FaqItem[] {
  ...
  const items: FaqItem[] = [
    {
      question: "Vibeollio는 어떤 플랫폼인가요?",
      answer:
        "Vibeollio는 바이브 코딩(Vibe Coding)으로 만든 프로젝트를 공유하고, 커뮤니티의 피드백과 평가를 받을 수 있는 쇼케이스 플랫폼입니다. 누구나 무료로 프로젝트를 등록하고 즉시 노출할 수 있습니다.",
    },
    {
  ...
  if (totalProjects > 0) {
    items.push({
      question: `현재 Vibeollio에 등록된 프로젝트는 몇 개인가요?`,
      answer: `현재 Vibeollio에는 ${totalProjects}개 이상의 바이브 코딩 프로젝트가 등록되어 있으며, 매일 새로운 프로젝트가 추가되고 있습니다.`,
    });
  }
  ...
  if (topTags.length > 0) {
    items.push({
      ...
      answer: `현재 Vibeollio에서 가장 활발한 태그는 ${topTags.join(", ")} 등이 있습니다. 다양한 분야의 바이브 코딩 프로젝트를 탐색할 수 있습니다.`,
    });
  }
  ...
  items.push(
    {
      ...
      answer:
        "아니요, Vibeollio에 프로젝트를 등록하는 것은 완전히 무료입니다. 계정을 만들고 프로젝트 정보를 입력하면 즉시 커뮤니티에 공개됩니다.",
    },
    {
      question: "Vibeollio에서 피드백은 어떻게 받을 수 있나요?",
      answer:
    ...
    <section className="mx-auto max-w-[1180px] px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="text-center">
        ...
        <p className="mt-2 text-sm text-foreground-muted">
          Vibeollio와 바이브 코딩에 대해 궁금한 점을 확인하세요
        </p>
      </div>
